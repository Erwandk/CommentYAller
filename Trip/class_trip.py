...
class Trip:
    ...
    def __init__(self, init_pos, final_pos, bagage, elevation, user_id=0):
        ...
        self.__recommendation = 'Recommandation'
    ...
    #     """
    #     if self.__elevation:
    #         # todo : récupérer le dénivelé dans un itinéraire vélo de google maps --> aller voir dans une autre API MAps
    ...
    def compute_recommendation(self):
        ...
        """
        print("compute_recommendation appelée")
        ...
        if self.__trip_foot.total_distance < 1001 and self.__weather_ok == True:
        ...
        # Si l'utilisateur n'est pas chargé et que les conditions météo sont bonnes, étude du trajet à vélo/vélib
        elif self.__bagage == False and self.__weather_ok == True: #  and self.__check_elevation == True:
            ...
            elif self.__pers_bicycle == False and self.__trip_velib.total_duration < self.__trip_transit.total_duration:
    ...
    def compute_trip(self):
        ...
        print("check-meteo {}".format(self.__check_weather))
